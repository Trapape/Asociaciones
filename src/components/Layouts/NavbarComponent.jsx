    ...
    <div>
        ...
        <div className="row py-1 px-lg-5">
          <div className="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
            <div className="d-inline-flex align-items-center text-white">
              <small><FontAwesomeIcon icon={faPhoneAlt} className="mr-2" style={{ transform: 'scaleX(-1)' }} />+52 123 456 7890</small>
              <small className="px-3">|</small>
              <small><FontAwesomeIcon icon={faEnvelope} className="mr-2" />contacto@Asociación.org</small>
            </div>
          </div>
      ...
      <nav className="navbar navbar-expand-lg bg-light navbar-light py-0 py-lg-0 px-lg-3">
        <NavLink to="/" className="navbar-brand ml-lg-3">
          <h1 className="m-2 text-uppercase text-primary" style={{ fontSize: '2rem' }}><FontAwesomeIcon icon={faTruck} className="mr-2" style={{ fontSize: '2.2rem' }}/>Asociación</h1>
        </NavLink>
